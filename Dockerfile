...
ENV CFLAGS="-matomics -mbulk-memory"
ENV CXXFLAGS="-matomics -mbulk-memory"


# Build x264
FROM emsdk-base AS x264-builder
ENV X264_BRANCH=4-cores
ADD https://ghfast.top/github.com/ffmpegwasm/x264.git#$X264_BRANCH /src
...
ENV X265_BRANCH=3.4
ADD https://ghfast.top/github.com/ffmpegwasm/x265.git#$X265_BRANCH /src
...
#ADD https://ghfast.top/github.com/ffmpegwasm/libvpx.git#$LIBVPX_BRANCH /src
...
#ADD https://ghfast.top/github.com/ffmpegwasm/lame.git#$LAME_BRANCH /src
...
#ADD https://ghfast.top/github.com/ffmpegwasm/Ogg.git#$OGG_BRANCH /src
...
#ADD https://ghfast.top/github.com/ffmpegwasm/theora.git#$THEORA_BRANCH /src
...
#ADD https://ghfast.top/github.com/ffmpegwasm/opus.git#$OPUS_BRANCH /src
...
#ADD https://ghfast.top/github.com/ffmpegwasm/vorbis.git#$VORBIS_BRANCH /src
...
#ADD https://ghfast.top/github.com/ffmpegwasm/zlib.git#$ZLIB_BRANCH /src
...
#ADD https://ghfast.top/github.com/ffmpegwasm/libwebp.git#$LIBWEBP_BRANCH /src
...
#ADD https://ghfast.top/github.com/ffmpegwasm/freetype2.git#$FREETYPE2_BRANCH /src
...
#ADD https://ghfast.top/github.com/fribidi/fribidi.git#$FRIBIDI_BRANCH /src
...
#ADD https://ghfast.top/github.com/harfbuzz/harfbuzz.git#$HARFBUZZ_BRANCH /src
...
#ADD https://ghfast.top/github.com/libass/libass.git#$LIBASS_BRANCH /src
...
#RUN git clone --recursive -b $ZIMG_BRANCH https://ghfast.top/github.com/sekrit-twc/zimg.git /src
...
ADD https://ghfast.top/github.com/FFmpeg/FFmpeg.git#$FFMPEG_VERSION /src
